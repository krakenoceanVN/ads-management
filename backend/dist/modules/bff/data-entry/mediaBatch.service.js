...
exports.saveMediaBatch = saveMediaBatch;
exports.confirmMediaBatch = confirmMediaBatch;
exports.unconfirmMedia = unconfirmMedia;
...
function validateMediaBatchItem(item, billingMethod) {
        ...
        try {
            ...
            if (existing) {
                ...
                await client_2.prisma.dailyInput.update({
                    ...
                    data: {
                        qty: item.qty ?? 0,
                        unitPriceSnapshot: item.unitPrice != null ? new client_1.Prisma.Decimal(String(item.unitPrice)) : undefined,
                        ...
                        ratioSnapshot: item.ratio != null ? new client_1.Prisma.Decimal(String(item.ratio)) : undefined,
...
async function confirmMediaBatch(recordDate, adSiteIds, userId) {
...
async function unconfirmMedia(id, userId) {
    return client_2.prisma.$transaction(async (tx) => {
...
//# sourceMappingURL=mediaBatch.service.js.map