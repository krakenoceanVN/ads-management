...
const loginRateLimiter = (0, rateLimit_js_1.createSimpleRateLimiter)({
    windowMs: 15 * 60 * 1000,
    max: 10,
...
// POST /api/auth/login
// ============================================================
router.post("/auth/login", loginRateLimiter.middleware, [
    ...
    try {
        ...
        const user = await prisma_js_1.default.user.findUnique({ where: { username: normalizedUsername } });
